...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_main,_write_ext_eeprom
...
write_ext_eeprom@data:	; 1 bytes @ 0x1
	ds   1
??_write_ext_eeprom:	; 1 bytes @ 0x2
	global	write_ext_eeprom@wait
write_ext_eeprom@wait:	; 2 bytes @ 0x2
	ds   2
	global	write_ext_eeprom@address
write_ext_eeprom@address:	; 1 bytes @ 0x4
	ds   1
??_main:	; 1 bytes @ 0x5
;!
;!Data Sizes:
...
l774:
;ext_eeprom.c: 7: i2c_start();
	call	_i2c_start	;wreg free
	line	8
	
l776:
;ext_eeprom.c: 8: i2c_write(0xA0);
	movlw	(0A0h)&0ffh
...
l778:
;ext_eeprom.c: 9: i2c_write(address);
...
l780:
;ext_eeprom.c: 10: i2c_write(data);
...
l782:
;ext_eeprom.c: 11: i2c_stop();
	call	_i2c_stop	;wreg free
	line	12
	
l784:
;ext_eeprom.c: 12: for(int wait = 50000;wait--;);
	movlw	high(-15536)
